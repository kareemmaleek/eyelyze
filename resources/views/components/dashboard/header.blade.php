<div x-data="{ open: false }" class="relative w-full h-14 bg-white shadow-md flex p-1 px-10 justify-end items-center">
    ...
    <div x-show="open" @click.away="open = false" x-transition class="absolute -bottom-20 right-5 w-38 h-fit bg-white rounded-lg p-2 shadow-lg">
