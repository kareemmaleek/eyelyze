<div class="w-full p-2 flex flex-col">
    ...
    @if (Auth::user()->role === 1)
        ...
        <x-dashboard.nav-link href="/system-log" :active="request()->is('system-log')">
            <x-heroicon-o-document-magnifying-glass class="w-6 h-6 text-lime-600" />
